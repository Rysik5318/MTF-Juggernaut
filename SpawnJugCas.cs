...
namespace MtfJuggernaut
{
    ...
    class SpawnJugCas : ParentCommand
    {
        public override string Command { get; } = "spawnjugcas";
        ...
        {
            if (!sender.CheckPermission("mjugcas.spawn"))
            {
                response = "У вас нет разрешения. Нужное разрешение: mjugcas.spawn. Если вы считаете, что должны иметь это разрешение, пожалуйста, напишите Rysik5318#7967";
                return false;
            }
